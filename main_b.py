...
def change_date():
    ...
    lines = ui.dataframe.plot.line(x='Hora', y=['16-bit Unsigned','16-bit Unsigned.1','16-bit Unsigned.2','16-bit Unsigned.3',])
    plt.show()
    return None
...
def generate_report():
    ...
    html = template.render(secada="",
                       ref='Daily S&P 500 prices report',
                       field1 ='Hello, welcome to your report!',
                       field2='Historical prices of S&P 500',
                       camara='Historical prices summary statistics',
                       temp="sp500_history",
                       time="sp500_history_summary",
                       date="")
